#!/bin/bash
#SBATCH --job-name=ppg_ss_profile_report
...
shift 2
run_dirs=("$@")
(( ${#run_dirs[@]} > 0 )) || { echo "ERROR: no profile runs" >&2; exit 2; }
work_root="/home/$USER/work/ppg_bp"
archive_root="/home/$USER/nas/ppg_bp"
project_root="${PPG_PROJECT_ROOT:?PPG_PROJECT_ROOT must name an immutable snapshot}"
run_id="same-subject-personal-profile-v1_${split_mode}_report_seed${seed}_job${SLURM_JOB_ID}"
...
echo "SAME_SUBJECT_PERSONAL_PROFILE_REPORT_COMPLETE=$run_id"

#!/bin/bash
#SBATCH --job-name=ppg_ss_profile_final
...
run_id="same-subject-personal-profile-v1_final_report_seed${seed}_job${SLURM_JOB_ID}"
...
cd "$project_root"
python -m pulsedb_fewshot.same_subject_personal_profile_report \
...
echo "SAME_SUBJECT_PERSONAL_PROFILE_FINAL_REPORT_COMPLETE=$run_id"

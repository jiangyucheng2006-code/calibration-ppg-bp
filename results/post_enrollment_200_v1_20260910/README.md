# 200 人新用户建档与个人参考记忆：结果及消融

核验日期：2026-09-10。协议：`post-enrollment-200-v1`。全部阶段正常完成；本次只整理和发布结果，没有提交新训练。

## 结论

从公共模型训练中完整排除 200 人，再为这些人分别建立个人 LoRA 和参考记忆后，完整方案的 Overall SBP/DBP MAE 为 **3.3312/1.8442 mmHg**。相较同一批人的单独 LoRA，SBP/DBP 平均 MAE 从 3.0453 降至 2.5877，降低 **15.03%**。186/200 人改善，14 人变差；没有剔除任何一个人。
...
| 方法 | Overall（200 人） | MIMIC（100 人） | VitalDB（100 人） | Overall 平均 MAE |
| --- | --- | --- | --- | --- |
| 个人 BP 均值（不使用当前 PPG） | 10.5711 / 5.6356 | 10.5242 / 5.6006 | 10.6180 / 5.6706 | 8.1034 |
| 共享网络 + 个人 BP 基准 | 9.9821 / 5.3499 | 10.3415 / 5.6239 | 9.6226 / 5.0759 | 7.6660 |
| 单独个人 LoRA | 3.9049 / 2.1858 | 4.2868 / 2.3628 | 3.5230 / 2.0088 | 3.0453 |
| 个人 LoRA + 参考记忆（完整方案） | 3.3312 / 1.8442 | 3.7162 / 2.0353 | 2.9463 / 1.6531 | 2.5877 |
| 共享特征检索记忆（无个人 LoRA） | 3.4846 / 1.9178 | 3.8867 / 2.1361 | 3.0825 / 1.6996 | 2.7012 |
| 共享网络预测 + 记忆融合（无个人 LoRA） | 4.3714 / 2.3521 | 4.7699 / 2.5645 | 3.9728 / 2.1397 | 3.3617 |
| LoRA 特征检索记忆（不融合预测头） | 3.3696 / 1.8519 | 3.7708 / 2.0602 | 2.9685 / 1.6436 | 2.6108 |
| LoRA + 记忆，邻居等权 | 3.3919 / 1.8740 | 3.7779 / 2.0638 | 3.0059 / 1.6842 | 2.6330 |
| LoRA + 记忆，固定各占一半 | 3.4078 / 1.8801 | 3.7842 / 2.0637 | 3.0314 / 1.6965 | 2.6439 |

## 四、完整方案相较配对 LoRA 的改善

| Scope | LoRA 平均 MAE | 完整方案平均 MAE | 降低 mmHg | 相对降低 | 降低量 95% CI | 改善人数 |
| --- | --- | --- | --- | --- | --- | --- |
| Overall | 3.0453 | 2.5877 | 0.4576 | 15.03% | [0.3930, 0.5232] | 186/200 |
| MIMIC | 3.3248 | 2.8757 | 0.4491 | 13.51% | [0.3642, 0.5403] | 93/100 |
| VitalDB | 2.7659 | 2.2997 | 0.4661 | 16.85% | [0.3741, 0.5644] | 93/100 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LoRA | SBP | 3.9049 | 0.9260 | 0.0705 | 5.7634 | 74.01% | 93.05% | 97.48% | PASS* | PASS (Grade A)* |
| LoRA | DBP | 2.1858 | 0.9269 | -0.1161 | 3.4760 | 91.31% | 98.40% | 99.45% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | SBP | 3.3312 | 0.9414 | -0.1154 | 5.1275 | 79.59% | 94.66% | 98.03% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | DBP | 1.8442 | 0.9388 | -0.1379 | 3.1782 | 93.48% | 98.58% | 99.49% | PASS* | PASS (Grade A)* |

### MIMIC

| Setting | BP | MAE | R² | ME | STD | ≤5 mmHg | ≤10 mmHg | ≤15 mmHg | AAMI | BHS |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LoRA | SBP | 4.2868 | 0.9234 | 0.1955 | 6.2786 | 71.08% | 91.38% | 96.55% | PASS* | PASS (Grade A)* |
| LoRA | DBP | 2.3628 | 0.9161 | -0.1720 | 3.9437 | 89.98% | 97.80% | 99.18% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | SBP | 3.7162 | 0.9387 | -0.0539 | 5.6179 | 76.13% | 93.18% | 97.38% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | DBP | 2.0353 | 0.9277 | -0.1422 | 3.6624 | 92.10% | 98.03% | 99.23% | PASS* | PASS (Grade A)* |

### VitalDB

| Setting | BP | MAE | R² | ME | STD | ≤5 mmHg | ≤10 mmHg | ≤15 mmHg | AAMI | BHS |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LoRA | SBP | 3.5230 | 0.9225 | -0.0545 | 5.1952 | 76.95% | 94.73% | 98.40% | PASS* | PASS (Grade A)* |
| LoRA | DBP | 2.0088 | 0.9405 | -0.0601 | 2.9341 | 92.65% | 99.00% | 99.73% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | SBP | 2.9463 | 0.9395 | -0.1768 | 4.5848 | 83.05% | 96.15% | 98.68% | PASS* | PASS (Grade A)* |
| LoRA + 记忆 | DBP | 1.6531 | 0.9530 | -0.1337 | 2.6059 | 94.85% | 99.13% | 99.75% | PASS* | PASS (Grade A)* |

[九种设置全部 54 行结果表](enrollment/RESULT_TABLES.md) · [Overall CSV](enrollment/Overall_diagnostics.csv) · [MIMIC CSV](enrollment/MIMIC_diagnostics.csv) · [VitalDB CSV](enrollment/VitalDB_diagnostics.csv)

## 六、消融实际说明了什么

- **个人建档有作用。** 共享网络加个人 BP 基准的 Overall 平均 MAE 为 7.6660，单独 LoRA 为 3.0453；两者平均 MAE 的配对改善覆盖 200/200 人。这支持在本预算下建立个人参数，而不是直接给新用户套用共享网络。
- **参考检索是强对照。** 不训练个人 LoRA、只用共享特征检索本人参考 BP，平均 MAE 已达 2.7012，优于单独 LoRA。完整方案再降到 2.5877，增益仅 0.1135 mmHg（138/200 人改善）。不能把完整方案比 LoRA 好的全部收益都归因于低秩参数与记忆的特殊协同。
- **融合预测头的增益较小。** 保留 LoRA 特征但只用记忆输出时，平均 MAE 为 2.6108，完整方案仅再改善 0.0230（122/200 人改善）。VitalDB 的 DBP 在该 memory-only 对照中为 1.6436，反而略好于完整方案的 1.6531。
- **权重与距离融合只带来小幅增益。** 相较邻居等权和固定一半融合，完整方案分别降低 Overall 平均 MAE 0.0452 和 0.0562 mmHg；不能据此声称巨大提升。固定一半融合的 Overall DBP STD 也略低于完整方案。
- **不是模块越多越好。** 无 LoRA 的共享预测加记忆融合，平均 MAE 为 3.3617，比共享特征的纯记忆输出更差。保留该负结果，而不只展示最佳模型。

本节新增的模块间直接配对描述是结果解释，不是新增的预注册主要假设；未为它们重新搜索参数或新增显著性声明。

## 七、剩余公共人群的单独基准

| Scope | 人数 | SBP MAE | DBP MAE | 平均 MAE |
| --- | --- | --- | --- | --- |
| Overall | 2305 | 3.8672 | 2.1512 | 3.0092 |
| MIMIC | 1112 | 4.1996 | 2.3116 | 3.2556 |
| VitalDB | 1193 | 3.5574 | 2.0016 | 2.7795 |
